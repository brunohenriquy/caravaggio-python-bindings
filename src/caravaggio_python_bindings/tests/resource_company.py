...
class CompanyResource(Resource):
    def list(self, params={}):
        return self.action(["companies", "company_search_list"], params=params, validate=False)

    def facets(self, params={}):
        return self.action(["companies", "company_search_facets"], params=params, validate=False)

    def get(self, id):
        return self.action(["companies", "company_read"], params={"id": id})

    def create(self, data):
        return self.action(["companies", "company_create"], params=data)

    def update(self, id, data, partial_update=True):
        action = "company_update" if not partial_update else "company_partial_update"
        ...
        return self.action(["companies", action], validate=(not partial_update), params=data)
    ...
    def delete(self, id):
        ...
        :return:
        """
        return self.action(["companies", "company_delete"], params={"id": id})
